...
local function UnloadBananiHub()
    ...
    elseif Rayfield.Unload then
        ...
        pcall(function()
            ...
            local Interface = Container:FindFirstChild("BananiUI")
                or Container:FindFirstChild("Rayfield")
                or Container:FindFirstChild("BANANIHUB")
    ...
    Callback = function(Option)
        ...
        local Themes = {
            ["Default"] = {
                ...
                TabBackground = Color3.fromRGB(48, 48, 48),
                TabStroke = Color3.fromRGB(68, 68, 68),
                TabBackgroundSelected = Color3.fromRGB(205, 205, 205),
                TabTextColor = Color3.fromRGB(225, 225, 225),
                SelectedTabTextColor = Color3.fromRGB(40, 40, 40),

                ElementBackground = Color3.fromRGB(36, 36, 36),
                ElementBackgroundHover = Color3.fromRGB(44, 44, 44),
                SecondaryElementBackground = Color3.fromRGB(29, 29, 29),
                ElementStroke = Color3.fromRGB(57, 57, 57),
                SecondaryElementStroke = Color3.fromRGB(46, 46, 46),

                SliderBackground = Color3.fromRGB(70, 70, 70),
                SliderProgress = Color3.fromRGB(185, 185, 185),
                SliderStroke = Color3.fromRGB(220, 220, 220),

                ToggleBackground = Color3.fromRGB(31, 31, 31),
                ToggleEnabled = Color3.fromRGB(190, 190, 190),
                ToggleDisabled = Color3.fromRGB(95, 95, 95),
                ToggleEnabledStroke = Color3.fromRGB(225, 225, 225),
                ToggleDisabledStroke = Color3.fromRGB(125, 125, 125),
                ToggleEnabledOuterStroke = Color3.fromRGB(145, 145, 145),
                ToggleDisabledOuterStroke = Color3.fromRGB(65, 65, 65),

                DropdownSelected = Color3.fromRGB(47, 47, 47),
                DropdownUnselected = Color3.fromRGB(34, 34, 34),

                InputBackground = Color3.fromRGB(31, 31, 31),
                InputStroke = Color3.fromRGB(67, 67, 67),
